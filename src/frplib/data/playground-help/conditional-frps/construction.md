...
The `conditional_frp` function is used to construct Conditional
FRPs in a variety of ways.

+ Passing a dictionary whose keys are values (or numbers in the codim 1 case)
  and whose "values" are FRPs.
  
+ Passing a function that accepts values and returns FRPs.
...
for the input. The flexible type signature of `conditional_frp`
